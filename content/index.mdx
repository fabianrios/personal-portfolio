...
import { Cards, Summary } from 'nextra/components'
...
- **Development**: Angular, React, Django, Next.js, TypeScript, Node.js, iOS development
- **Design**: UI/UX, Interactive Design, Prototyping
- **Art**: Digital Media, Interactive Installations
- **Other**: Data Visualization, Creative Coding

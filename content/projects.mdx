...
<ul className={"project-list"}>
 ...
 <li><a href="#trolley-game">Trolley Game</a> <small>2025</small></li>
...
<a href={'https://apps.apple.com/us/app/onomationary/id6751577592'} className="app-store" target="_blank">
    <Image
...
## Trolley Game
### A Ruthlessly Funny Moral Dilemma Simulator
2025

![trolley-game](/images/trolley-shot-web.png)

<a href={'https://apps.apple.com/de/app/trolley-problem-choices-game/id6751812614?l=en-GB'} className="app-store" target="_blank">
    <Image
        src="/images/app-store.png"
        alt="app store"
        width={496}

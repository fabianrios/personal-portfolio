...
This work is a geographical and time based explorer of different tagged events between more than 50 years of Colombian conflict,
A way to navigate the internal truth commission database. information can be explore ranging from different dates or geographic locations

![timeline](/images/colombia_viz_linea_de_tiempo.png)
<small class="text-center">Screenshot main UI</small>

every item/event was expandable so further information could be seen on a modal with associated tags possible "involved groups"

...
<
<li><a href="#the-onomatopoeia-soundbook">The Onomatopoeia Soundbook</a> <small>2025</small></li>
...
**Onomationary** is a digital soundbook (iOS, swift) that explores the onomatopoeias of six different languages: English, Spanish, French, German, Italian, and Japanese. It features a collection of sounds associated with various animals, objects, and actions, each represented by an emoji. Users can click on an emoji to hear the corresponding sound in each language, providing an interactive way to experience linguistic diversity.

![onomationary](/images/onomationary.png)
<small class="text-center">Screenshots fullscreen</small>

## Art and political violence in Colombia
2024

![sobrepuente](/images/arte-violencia-en-colombia.jpg)
<small class="text-center">Screenshot fullscreen</small>
...
<small class="text-center">Screenshot detail</small>
...
<small class="text-center">Game play</small>
